...
Command: npx gltfjsx@6.2.16 .\public\assets\Gaudi_Clean.glb 
*/

import React, { useRef, useEffect } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

const Gaudi_Clean = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./assets/Gaudi_Clean.glb')
...
useGLTF.preload('./assets/Gaudi_Clean.glb')

export default Gaudi_Clean